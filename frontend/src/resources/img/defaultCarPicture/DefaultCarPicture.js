...
import StyledDefaultCarPicture from './StyledDefaultCarPicture';

function DefaultCarPicture({ className }) {
    const componentClassName = `DefaultCarPicture ${className}`;

    return (
        <StyledDefaultCarPicture viewBox='0 0 66.1 53.88' className={componentClassName}>
            <path className='DefaultCarPicture-Background'
            ...
            <path className='DefaultCarPicture-Outline'
            ...
            <path className='DefaultCarPicture-Windshield'
            ...
            <circle className='DefaultCarPicture-Headlight' cx='13.22' cy='27.89' r='3.58' />

            <circle className='DefaultCarPicture-Headlight' cx='51.46' cy='27.89' r='3.58' />

            <path className='DefaultCarPicture-Smile' d='M23 33.23a24.85 24.85 0 0 0 10.27 2.71A21 21 0 0 0 43 33.23' />
        </StyledDefaultCarPicture>
    )
}
